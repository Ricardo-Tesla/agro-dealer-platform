...
const Products = ({ supplierFilter = null, onClose }) => {
  ...
  useEffect(() => {
    // Open modal if supplierFilter exists (from Suppliers page)
    if (supplierFilter) {
      setFormData((prev) => ({ ...prev, supplier: supplierFilter }));
      setIsModalOpen(true);
    }
  }, [supplierFilter]);
  ...
  useEffect(() => {
    ...
    } else if (isModalOpen && !supplierFilter) {
      setFormData({
        name: "",
        category: "",
        quantity: "",
    ...
    setFormErrors({});
  }, [editingProduct, isModalOpen, supplierFilter]);
            ...
            <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  />
                  {formErrors.minStock && (
                    <p className="text-red-500 text-xs mt-1">{formErrors.minStock}</p>
                  )}
                </div>
